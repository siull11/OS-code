...
# python3 plots/plot.py -t "Times for test 1 with varying amount of processes and calculation size" -d output -f test1-1.csv test1-2.csv test1-3.csv test1-4.csv test1-5.csv test1-6.csv test1-7.csv test1-8.csv test1-9.csv test1-10.csv test1-11.csv test1-12.csv test1-13.csv test1-14.csv test1-15.csv test1-16.csv -l "1 process" "2 processes" "3 processes" "4 processes" "5 processes" "6 processes" "7 processes" "8 processes" "9 processes" "10 processes" "11 processes" "12 processes" "13 processes" "14 processes" "15 processes" "16 processes" -x "length, n" -y "time [s]" -r 1 -cx 0 -cy 2 -a 10
# python3 plots/plot.py -t "Times for test 2 with varying amount of processes and calculation size" -d output -f test2-1.csv test2-2.csv test2-3.csv test2-4.csv test2-5.csv test2-6.csv test2-7.csv test2-8.csv test2-9.csv test2-10.csv test2-11.csv test2-12.csv test2-13.csv test2-14.csv test2-15.csv test2-16.csv -l "1 process" "2 processes" "3 processes" "4 processes" "5 processes" "6 processes" "7 processes" "8 processes" "9 processes" "10 processes" "11 processes" "12 processes" "13 processes" "14 processes" "15 processes" "16 processes" -x "length, n" -y "time [s]" -r 1 -cx 0 -cy 2 -a 10
